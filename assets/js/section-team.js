...
window.addEventListener("DOMContentLoaded", function () {
  setTimeout(function () {
    ...
    function teamAnimation() {
      ...
      teamsList.forEach( /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(team, index) {
          var imageWrappers, timeout;
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                imageWrappers = team.querySelectorAll(".js-team__image-wrapper");
                timeout = 0;
                if (resize) {
                  timeout = 500;
                  if (gs[index]) {
